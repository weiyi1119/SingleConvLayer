...
HD_PWD='D:/Xilinx/lwyVerilog/kernel3x3x3/kernel3x3x3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log single_layer_conv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source single_layer_conv.tcl -notrace
