...
HD_PWD='D:/Xilinx/lwyVerilog/kernel3x3x3/kernel3x3x3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_layer_conv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_layer_conv.tcl
